...
export function NamespacedStreamsCodeWorkbench({
  ...
  stepGutterMarks,
  stepTone,
}: NamespacedStreamsCodeWorkbenchProps) {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      <CodePane
        ...
        filename="workflows/namespaced-streams.ts"
